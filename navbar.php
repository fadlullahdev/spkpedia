<nav class="sticky z-50 top-0 left-0 right-0 bg-white shadow-sm dark:bg-gray-800/95 dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10" id="navbar">
        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    ...
                    <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-300 dark:hover:border-white/20 dark:hover:text-white">About</a>
                </div>
            </div>
    ...
    <div id="mobile-menu" class="hidden sm:hidden opacity-0 transition-opacity duration-200">
        <div class="space-y-1 pt-2 pb-3">
            ...
            <a href="#" class="block border-l-4 border-transparent py-2 pr-4 pl-3 text-base font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700 dark:text-gray-300 dark:hover:border-white/20 dark:hover:bg-white/5 dark:hover:text-white">About</a>
        </div>
