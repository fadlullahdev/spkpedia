...
<head>
    ...
    <title>Register | Ensiklopedia Sistem Pendukung Keputusan</title>
...
<body class="bg-white dark:bg-gray-900">
    ...
    <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <h2 class="mt-6 text-center text-2xl/9 font-bold tracking-tight text-gray-900 dark:text-gray-100">Register your account</h2>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 px-6 py-12 shadow-sm mx-2 md:mx-0 rounded-lg sm:px-12">
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <label for="fullname" class="block text-[12px] text-gray-900 dark:text-gray-100 mt-1">Use your active email address</label>
                    </div>
                   ...
                   placeholder:text-gray-400 dark:placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm" />
                    ...
                    m4.242 4.242L9.88 9.88" />
                        ...
                        <label for="fullname" class="block text-[12px] text-gray-900 dark:text-gray-100 mt-1">Use at least 8 characters with a combination of letters and numbers</label>
                    </div>

                    <div>
                        <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 hover:cursor-pointer">Register</button>
                    </div>
                </form>
